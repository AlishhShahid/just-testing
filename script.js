...
form.addEventListener('submit', function (event) {
    ...
    // Generate a shareable URL with the path to the main.html file
    var shareableURL = "".concat(window.location.origin, "/main.html?username=").concat(encodeURIComponent(username));
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    if (username) {
        ...
        if (savedResumeData) {
            ...
            // Also update the resume display section
